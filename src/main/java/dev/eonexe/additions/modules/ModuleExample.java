...
public class ModuleExample extends Module {
    ...
    public ModuleExample() {
        super(Additions.CATEGORY, "world-origin", "An example module that highlights the center of the world.");
    }

    /**
     * Example event handling method.
     * Requires {@link Additions#getPackage()} to be setup correctly, will fail silently otherwise.
     */
    @EventHandler
