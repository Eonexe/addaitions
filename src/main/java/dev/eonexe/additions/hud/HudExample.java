package dev.eonexe.additions.hud;
...
public class HudExample extends HudElement {
     ...
     */
    public static final HudElementInfo<HudExample> INFO = new HudElementInfo<>(Additions.HUD_GROUP, "example", "HUD element example.", HudExample::new);
